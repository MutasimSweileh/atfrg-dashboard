...
<b-card>
    ...
    <b-table :dark="dark" :hover="hover" :striped="striped" :bordered="bordered" :small="small" :fixed="fixed" responsive="sm" :items="items" :fields="captions" :current-page="currentPage" :per-page="perPage" @row-clicked="rowClicked">
        <template slot="Changes" slot-scope="data">
            <router-link :to="'./seasons/' + data.item.id"><i class='fa fa-edit'></i></router-link>
        </template>
        <template slot="Series" slot-scope="data">
            <b-badge v-if="data.item.Series != null" :variant="data.item.Series.title">
                <router-link :to="'/serieses/'+ data.item.Series.id">{{data.item.Series.title}}</router-link>
            </b-badge>
        </template>
        ...
        <template slot="publisher" slot-scope="data">
            <b-badge v-if="data.item.publisher != null" :variant="data.item.publisher.username">
                <router-link :to="'/users/'+ data.item.publisher.id">{{data.item.publisher.username}}</router-link>
            </b-badge>
        </template>
    </b-table>
    <nav>

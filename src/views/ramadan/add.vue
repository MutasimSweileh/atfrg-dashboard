        ...
        <b-row>
            <b-col cols="12">
                <b-card header-tag="header" footer-tag="footer">
                    <div slot="header">
                        <i class="fa fa-align-justify"></i><strong> اضافة مسلسل </strong>
                    </div>
                    <!-- Main Information -->
                    <b-card>
                        <div slot="header">
...
const Add_Series = gql `
 ...
 const Add_Season = gql `
  mutation Season($title:String!,$releaseDate:DateTime!,$trailerPath:String,$posters:[ImageCreateInput!],$imdbId:String)
  {
  createSeason(
    data: {
    imdbId:$imdbId,
